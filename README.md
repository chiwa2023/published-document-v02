...
- 現在対応中なのはV5(2019年-)
- 他プロジェクトに導入されることが前提のため、Javaのjar化、Viteライブラリ化がされている
...
- 公式XMLについて、値の制限(ex.団体名は60文字以内)が発表された場合は、validationとして値制限機能を追加する。
...
- jarが更新された場合はpom.xmlのバージョン番号を更新(し起動またはinstall)する
