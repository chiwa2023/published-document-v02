...
/**
 * Sheet071809LoanAmongAssetsDto単体テスト
 */
class Sheet071809LoanAmongAssetsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071809LoanAmongAssetsDto sheet0 = new Sheet071809LoanAmongAssetsDto();
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071809_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071809_list.txt");
