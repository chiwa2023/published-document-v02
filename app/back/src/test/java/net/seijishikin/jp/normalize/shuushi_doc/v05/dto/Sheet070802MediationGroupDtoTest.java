...
/**
 * Sheet070802MediationGroupDto単体テスト
 */
class Sheet070802MediationGroupDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet070802MediationGroupDto sheet0 = new Sheet070802MediationGroupDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070802_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070802_list.txt");
