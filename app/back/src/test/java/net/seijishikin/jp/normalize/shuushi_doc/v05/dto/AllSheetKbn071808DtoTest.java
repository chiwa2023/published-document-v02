 ...
 */
class AllSheetKbn071808DtoTest {
    ...
    void testConvretXml() throws Exception { // NOPMD
        ...
        allSheetKbn071808Dto.setSheet071808InvestmentAmongAssetsDto(sheet1);

        XmlMapper xmlMapper = new XmlMapper();
        xmlMapper.enable(SerializationFeature.INDENT_OUTPUT);

        String xml0 = xmlMapper.writeValueAsString(allSheetKbn071808Dto);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/kbn_071808_list.txt");
