...
/**
 * Sheet070702DonateGroupDto単体テスト
 */
class Sheet070702DonateGroupDtoTest {
    ...
    void testConvretXml() throws Exception {
       ...
       xmlMapper.enable(SerializationFeature.INDENT_OUTPUT);
        ...
        // リスト0
        Sheet070702DonateGroupDto sheet0 = new Sheet070702DonateGroupDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070702_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070702_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Sheet070702DonateGroupDto sheet1 = new Sheet070702DonateGroupDto();
