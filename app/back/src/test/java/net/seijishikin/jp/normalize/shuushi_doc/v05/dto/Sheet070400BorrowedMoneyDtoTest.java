...
/**
 * Sheet070400BorrowedMoneyDto単体テスト
 */
class Sheet070400BorrowedMoneyDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet070400BorrowedMoneyDto sheet0 = new Sheet070400BorrowedMoneyDto();
        sheet0.setPageTotal(30000L);
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070400_none.txt");
        String answer0 = Files.readString(pathAnswer0);
        assertEquals(answer0,xml0);

        // リスト存在
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_070400_list.txt");
