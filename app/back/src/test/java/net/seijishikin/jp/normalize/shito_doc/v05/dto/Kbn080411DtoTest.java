...
class Kbn080411DtoTest {
    ...
    void testConvertXml() throws Exception {
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/party_usage/kbn_080411_dto_none.txt");
        String answer0 = Files.readString(pathAnswer0);

        Kbn080411Dto kbn0 = new Kbn080411Dto();
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/party_usage/kbn_080411_dto_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Kbn080411Dto kbn1 = new Kbn080411Dto();
