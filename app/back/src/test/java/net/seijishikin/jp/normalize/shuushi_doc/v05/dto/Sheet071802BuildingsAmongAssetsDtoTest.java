...
/**
 * Sheet071802BuildingsAmongAssetsDto単体テスト
 */
class Sheet071802BuildingsAmongAssetsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071802BuildingsAmongAssetsDto sheet0 = new Sheet071802BuildingsAmongAssetsDto();
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071802_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071802_list.txt");
