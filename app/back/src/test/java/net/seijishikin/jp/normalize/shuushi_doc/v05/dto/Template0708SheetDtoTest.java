...
/**
 * Template0708SheetDto単体テスト
 */
class Template0708SheetDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Template0708SheetDto sheet0 = new Template0708SheetDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0708_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0708_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Template0708SheetDto sheet1 = new Template0708SheetDto();
