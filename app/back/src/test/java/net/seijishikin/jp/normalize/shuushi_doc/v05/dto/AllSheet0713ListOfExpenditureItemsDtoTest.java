...
/**
 * AllSheet0713ListOfExpenditureItemsDto単体テスト
 */
class AllSheet0713ListOfExpenditureItemsDtoTest {
    // CHECKSTYLE:OFF
    ...
    void testConvretXml() throws Exception { // NOPMD
        ...
        allSheet0713ListOfExpenditureItemsDto.setSheet071300ListOfExpenditureItemsDto(sheet0);

        XmlMapper xmlMapper = new XmlMapper();
        xmlMapper.enable(SerializationFeature.INDENT_OUTPUT);

        String xml0 = xmlMapper.writeValueAsString(allSheet0713ListOfExpenditureItemsDto);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/all_sheet_0713.txt");
