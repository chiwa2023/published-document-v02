...
/**
 * Template0707SheetDto単体テスト
 */
class Template0707SheetDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Template0707SheetDto sheet0 = new Template0707SheetDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0707_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0707_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Template0707SheetDto sheet1 = new Template0707SheetDto();
