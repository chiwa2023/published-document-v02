...
/**
 * AllSheet0701CoverAndOrganizationDetailsDto単体テスト
 */
class AllSheet0701CoverAndOrganizationDetailsDtoTest {
    ...
    void testConvretXml() throws Exception { // NOPMD
        ...
        String xml0 = xmlMapper.writeValueAsString(allSheet0701CoverAndOrganizationDetailsDto);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/all_sheet_0701.txt");
