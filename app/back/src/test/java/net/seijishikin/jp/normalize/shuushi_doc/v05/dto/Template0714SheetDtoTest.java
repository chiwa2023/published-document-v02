...
/**
 * Template0714SheetDto単体テスト
 */
class Template0714SheetDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071403OfficeExpensesDto sheet0 = new Sheet071403OfficeExpensesDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0714_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/template_0714_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Template0714SheetDto sheet1 = new Template0714SheetDto();
