...
/**
 * Sheet071506OtherBusinessExpensesDto単体テスト
 */
class Sheet071506OtherBusinessExpensesDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071506OtherBusinessExpensesDto sheet0 = new Sheet071506OtherBusinessExpensesDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071506_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071506_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Sheet071506OtherBusinessExpensesDto sheet1 = new Sheet071506OtherBusinessExpensesDto();
