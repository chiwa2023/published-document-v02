...
/**
 * Sheet071509OtherExpensesDto単体テスト
 */
class Sheet071509OtherExpensesDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071509OtherExpensesDto sheet0 = new Sheet071509OtherExpensesDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071509_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071509_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Sheet071509OtherExpensesDto sheet1 = new Sheet071509OtherExpensesDto();
