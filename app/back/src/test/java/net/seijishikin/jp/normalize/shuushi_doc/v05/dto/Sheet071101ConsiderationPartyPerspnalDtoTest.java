...
/**
 * Sheet071101ConsiderationPartyPerspnalDto単体テスト
 */
class Sheet071101ConsiderationPartyPerspnalDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071101ConsiderationPartyPerspnalDto sheet0 = new Sheet071101ConsiderationPartyPerspnalDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071101_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071101_list.txt");
