...
/**
 * AllSheet0702SummaryTableIncomeDto単体テスト
 */
class AllSheet0702SummaryTableIncomeDtoTest {
    ...
    void testConvretXml() throws Exception { // NOPMD
        ...
        allSheet0702SummaryTableIncomeDto.setSheet070200SummaryTableIncomeExpenditureDto(sheet0);
        
        XmlMapper xmlMapper = new XmlMapper();
        xmlMapper.enable(SerializationFeature.INDENT_OUTPUT);
        
        String xml0 = xmlMapper.writeValueAsString(allSheet0702SummaryTableIncomeDto);
        
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/all_sheet_0702.txt");
