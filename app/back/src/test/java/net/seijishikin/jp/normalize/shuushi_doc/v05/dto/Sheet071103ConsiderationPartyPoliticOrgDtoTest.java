...
/**
 * Sheet071103ConsiderationPartyPoliticOrgDto単体テスト
 */
class Sheet071103ConsiderationPartyPoliticOrgDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071103ConsiderationPartyPoliticOrgDto sheet0 = new Sheet071103ConsiderationPartyPoliticOrgDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071103_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071103_list.txt");
