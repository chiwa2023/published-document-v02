 ...
 */
class AllSheetKbn071503DtoTest {
    ...
    void testConvretXml() throws Exception { // NOPMD
        ...
        Sheet071503MagazinePublicationDto sheet1 = new Sheet071503MagazinePublicationDto();
        ...
        allSheetKbn071503Dto.getList().add(sheet1);

        XmlMapper xmlMapper = new XmlMapper();
        xmlMapper.enable(SerializationFeature.INDENT_OUTPUT);

        String xml0 = xmlMapper.writeValueAsString(allSheetKbn071503Dto);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/kbn_071503_list.txt");
