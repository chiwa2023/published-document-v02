...
/**
 * Sheet071504AdvertisingExpensesDto単体テスト
 */
class Sheet071504AdvertisingExpensesDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071504AdvertisingExpensesDto sheet0 = new Sheet071504AdvertisingExpensesDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071504_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071504_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Sheet071504AdvertisingExpensesDto sheet1 = new Sheet071504AdvertisingExpensesDto();
