...
/**
 * Sheet071401UtilityCostsDto単体テスト
 */
class Sheet071401UtilityCostsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071401UtilityCostsDto sheet0 = new Sheet071401UtilityCostsDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071401_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071401_list.txt");
