...
/**
 * Sheet071812BorrowingsAmongAssetsDto単体テスト
 */
class Sheet071812BorrowingsAmongAssetsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071812BorrowingsAmongAssetsDto sheet0 = new Sheet071812BorrowingsAmongAssetsDto();
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071812_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071812_list.txt");
