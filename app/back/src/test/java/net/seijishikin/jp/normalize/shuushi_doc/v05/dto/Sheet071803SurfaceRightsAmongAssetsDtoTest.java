...
/**
 * Sheet071803SurfaceRightsAmongAssetsDto単体テスト
 */
class Sheet071803SurfaceRightsAmongAssetsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071803SurfaceRightsAmongAssetsDto sheet0 = new Sheet071803SurfaceRightsAmongAssetsDto();
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071803_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071803_list.txt");
