...
/**
 * Sheet071502ElectionRelatedExpensesDto単体テスト
 */
class Sheet071502ElectionRelatedExpensesDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071502ElectionRelatedExpensesDto sheet0 = new Sheet071502ElectionRelatedExpensesDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071502_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071502_list.txt");
        String answer1 = Files.readString(pathAnswer1);

        Sheet071502ElectionRelatedExpensesDto sheet1 = new Sheet071502ElectionRelatedExpensesDto();
