...
/**
 * Sheet071810DepositAmongAssetsDto単体テスト
 */
class Sheet071810DepositAmongAssetsDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071810DepositAmongAssetsDto sheet0 = new Sheet071810DepositAmongAssetsDto();
        String xml0 = xmlMapper.writeValueAsString(sheet0);

        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071810_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071810_list.txt");
