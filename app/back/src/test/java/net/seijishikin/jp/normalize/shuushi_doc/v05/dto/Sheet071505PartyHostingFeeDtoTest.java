...
/**
 * Sheet071505PartyHostingFeeDto単体テスト
 */
class Sheet071505PartyHostingFeeDtoTest {
    ...
    void testConvretXml() throws Exception {
        ...
        // リスト0
        Sheet071505PartyHostingFeeDto sheet0 = new Sheet071505PartyHostingFeeDto();
        ...
        Path pathAnswer0 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071505_none.txt");
        ...
        Path pathAnswer1 = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "dto/publish/balancesheet/sheet_071505_list.txt");
